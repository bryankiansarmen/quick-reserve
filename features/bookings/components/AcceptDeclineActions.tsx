    ...
    <div className="flex flex-col items-end gap-1.5">
      <div className="flex gap-2">
        ...
        <button
          ...
          disabled={isPending}
          className="inline-flex items-center gap-1.5 rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-red-600 shadow-sm hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:opacity-50 dark:border-slate-800 dark:bg-slate-900 dark:text-red-400 dark:hover:bg-red-950/20 transition-colors"
          aria-busy={isPending}
        >
          Decline
        </button>
